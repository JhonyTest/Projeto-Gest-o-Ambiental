 ...
 * @author Joao Pedro
 */
public class FrMenuCadastro extends javax.swing.JFrame {

    /**
     * Creates new form FrMenuCadastro
     */
    public FrMenuCadastro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblMenuPrincipal.setText("Menu Cadastro");

        btnCadAluno.setText("Cadastro Fiscal");
        btnCadAluno.setFocusPainted(false);
        btnCadAluno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCadFiscalActionPerformed(evt);
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrMenuCadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrMenuCadastro().setVisible(true);
            }
        });
    }
